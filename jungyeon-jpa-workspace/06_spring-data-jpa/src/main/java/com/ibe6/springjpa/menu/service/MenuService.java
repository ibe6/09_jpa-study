package com.ibe6.springjpa.menu.service;

import com.ibe6.springjpa.menu.dto.CategoryDto;
import com.ibe6.springjpa.menu.dto.MenuDto;
import com.ibe6.springjpa.menu.entitiy.Category;
import com.ibe6.springjpa.menu.entitiy.Menu;
import com.ibe6.springjpa.menu.repository.CategoryRepository;
import com.ibe6.springjpa.menu.repository.MenuRepository;
import com.ibe6.springjpa.util.PageUtil;
...
public class MenuService {
    ...
    public void removeMenu(int code){
        ...
        Menu menu = menuRepository.findById(code).orElseThrow(() -> new IllegalArgumentException("잘못된 메뉴 번호입니다."));
