...
public class ProjectionJPQLTest {
    ...
    public void 엔티티_프로젝션_테스트() {
        ...
        String jpql = "SELECT m FROM menu2 m WHERE m.menuCode = 11";
    ...
    public void new_DTO_프로젝션_테스트(){
        String jpql = "SELECT new com.ibe6.section02.projection.CategoryResponseDto(c.categoryCode, c.categoryName) FROM category2 c";
